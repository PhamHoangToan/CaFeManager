...
export default function AddImportPage() {
  const items = [
    { code: "CAFE", name: "Ground Coffee", unit: "Kg", qty: 10, price: 170000 },
    { code: "DUONG", name: "Sugar", unit: "Kg", qty: 25, price: 23000 },
  ];
  ...
  return (
    <div className="p-6 bg-[#F4E1D2] min-h-screen border border-[#B7855E] rounded-md">
      <div className="flex justify-between items-center bg-[#5C2C1C] text-white px-4 py-2 rounded-t-md">
        <h2 className="font-semibold text-lg">Add Import Receipt</h2>
      ...
      <div className="p-4 space-y-4 text-sm">
        <div className="grid grid-cols-4 gap-4">
          ...
          <div>
            ...
            <input
              className="w-full border border-[#B7855E] rounded px-2 py-1"
              defaultValue="Dasfoods - 247 Pham Ba Chau"
            />
          </div>
        </div>
